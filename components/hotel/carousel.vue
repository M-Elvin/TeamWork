    ...
    <div class="search-form" >
        ...
        <el-form class="search-form-content"  ref="form" >
            ...
            <el-form-item class="search-form-inp">
                    ...
                    <div class="main-tar">商圈、地表、酒店、关键字</div>
                </div>
...
export default {
    ...
    data(){
        return {
            ...
            outtime:"",
            colors:['#f25','#2f5','#25f'],
            startext:['一星级',"二星级","三星级","四星级","五星级"],
            banners: [

                {
                    url: "https://www.shangri-la.com/uploadedImages/Shangri-la_Hotels/SC_Owned_Channel_Asset_Family_Asset_Shangrila_Site_HomepageBanner_1920_800.jpg",
                },
                {
                    url:"https://www.shangri-la.com/uploadedImages/Shangri-la_Hotels/New_Website/Banner-1920-x-800.jpg",
                },
                ...
                {
                    url: "https://www.shangri-la.com/uploadedImages/Shangri-la_Hotels/MB_SC5.jpg",
                },
                {
